      ...
      <div className="main_container">
        <div id="campuslifep">
          ...
          <div id="campus_content">
            ...
            <p id="campuscontent">
              The IITR campus provides a number of utilitarian amenities that
              make its students' lives on campus trouble free. These include
              eateries from Amul and Nescafe to the famed CCD, banks like SBI
              and PNB as well as 3-4 ATMs, a well equipped hospital in case of
              emergencies and 3 guesthouses for accommodation of guests and
              delegates who visit the campus. The campus has a mandir, a church,
              and a masjid, a post office which is well equipped and caters to
              the need of the students and the faculty, as well as the non
              residents on campus, and also provides its students with a number
              of sports facilities for them to excel in the sport of their
              choice.
            </p>
          </div>
        </div>
